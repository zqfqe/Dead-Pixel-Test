...
const PPICalculator: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="PPI Calculator - Pixel Density & Retina Distance" 
        description="Calculate PPI (Pixels Per Inch), dot pitch, and ideal viewing distance (Retina distance) for any display. Supports 4K, 1440p, Ultrawide, and Mobile resolutions."
        canonical="/tools/ppi-calculator"
        keywords={['ppi calculator', 'pixel density calculator', 'dot pitch calculator', 'retina distance', 'screen size calculator', '4k ppi']}
        breadcrumbs={[
          { name: 'Home', path: '/' },

...
const Contact: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="Contact Support - DeadPixelTest.cc" 
        description="Have questions about dead pixels or our testing tools? Contact the DeadPixelTest team for support and feedback."
        canonical="/contact"
      />

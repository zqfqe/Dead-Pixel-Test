...
const Terms: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="Terms of Service - DeadPixelTest.cc" 
        description="Terms and conditions for using DeadPixelTest.cc. Includes important health warnings regarding photosensitive epilepsy."

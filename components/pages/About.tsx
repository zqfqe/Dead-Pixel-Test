...
const About: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="About Us - DeadPixelTest.cc" 
        description="We provide professional-grade, browser-based display testing tools. Learn about our mission to help consumers win the 'Panel Lottery'."
        canonical="/about"
        jsonLd={{
